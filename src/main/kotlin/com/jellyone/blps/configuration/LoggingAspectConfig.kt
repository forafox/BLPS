...
class LoggingAspectConfig {
     ...
     */
    @Pointcut("@annotation(com.jellyone.blps.configuration.annotation.Loggable)")
    fun loggableMethods() {
    }
     ...
     */
    @Pointcut(
        "within(com.jellyone.blps..*) " +
                "|| within(com.jellyone.blps.service..*) " +
                "|| within(com.jellyone.blps.controller..*)"
    )
